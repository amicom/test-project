...
LangString UnrecognisedInstallPath ${LANG_GERMAN} "Installationspfad nicht erkannt (Portable Version?). Trotzdem fortfahren?"
LangString JDExeNotFound ${LANG_GERMAN} "JDownloader.exe nicht am Installationsort gefunden. Trotzdem fortfahren?"
