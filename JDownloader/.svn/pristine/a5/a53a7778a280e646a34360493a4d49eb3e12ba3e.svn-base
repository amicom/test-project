...
public class MyJDRemoteAPIRequest extends RemoteAPIRequest {
    ...
    public MyJDRemoteAPIRequest(InterfaceHandler<?> iface, String methodName, String[] parameters, MyJDownloaderRequestInterface request) throws IOException, ApiCommandNotAvailable {
