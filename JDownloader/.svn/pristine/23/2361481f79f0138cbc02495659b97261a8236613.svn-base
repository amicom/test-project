 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 29090 $", interfaceVersion = 2, names = { "watchseries.ag" }, urls = { "https?://(?:www\\.)?(?:watchseries\\.ag|watchtvseries\\.(?:se|vc))/(episode/.*?\\.html|open/cale/\\d+\\.html)" }, flags = { 0 })
