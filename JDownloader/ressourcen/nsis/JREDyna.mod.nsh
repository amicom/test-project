...
NoFound:
  ...
  ${NSD_CreateLabel} 0 0 100% 100% $(JRE_INSTALL_TEXT)
  pop $1
  goto ShowDialog

FoundOld:
  !insertmacro MUI_HEADER_TEXT $(JRE_UPDATE_TITLE) $(JRE_UPDATE_HEADLINE)
  ${NSD_CreateLabel} 0 0 100% 100% $(JRE_UPDATE_TEXT)
  pop $1
  goto ShowDialog
