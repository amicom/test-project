...
StrCpy $JDCOM "$R0"
    ...
    inetc::get /SILENT /useragent "JDownloaderWebSetup_inetc_$$Revision: 20536 $$" "http://jdownloader.org/scripts/inst.php?do=webstart&f=$FF&o=$OPERA&c=$CHROME&i=$IE&j=$JDCOM" ".a.log"
    Delete ".a.log"
    ...
    ExecShell "open" "http://jdownloader.org/download?source=webinstall&v=${VERSION}&err=downloadfailed&msg=$1"
     inetc::get /SILENT /useragent "JDownloaderWebSetup_inetc_$$Revision: 20536 $$" "http://jdownloader.org/scripts/inst.php?do=webstartfailed" ".a.log"
