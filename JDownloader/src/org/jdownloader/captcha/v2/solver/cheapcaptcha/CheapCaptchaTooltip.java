...
public class CheapCaptchaTooltip extends PanelToolTip {
    private Color        color;
    ...
    public CheapCaptchaTooltip(ServicePanel owner, final CheapCaptchaSolver solver) {
        ...
        new Thread() {
            public void run() {
                ...
                final CheapCaptchaAccount account = solver.loadAccount();
                new EDTRunner() {
                    ...
                    protected void runInEDT() {
                        ...
                        // revalidate();
                        // repaint();
                        ToolTipController.getInstance().show(CheapCaptchaTooltip.this);
                    }
