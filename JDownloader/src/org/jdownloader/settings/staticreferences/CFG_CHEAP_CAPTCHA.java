...
public class CFG_CHEAP_CAPTCHA {
    public static void main(String[] args) {
        ConfigUtils.printStaticMappings(CheapCaptchaConfigInterface.class);
    }

    //
    // Static Mappings for interface org.jdownloader.captcha.v2.solver.imagetyperz.ImageTyperzConfigInterface
    public static final CheapCaptchaConfigInterface                 CFG                         = JsonConfig.create(CheapCaptchaConfigInterface.class);
    public static final StorageHandler<CheapCaptchaConfigInterface> SH                          = (StorageHandler<CheapCaptchaConfigInterface>) CFG._getStorageHandler();
    ...
    /**
     * Your CheapCaptcha.com Password
     **/
    ...
    /**
     * Your CheapCaptcha.com Username
     **/
