...
import org.jdownloader.extensions.streaming.dlna.profiles.rawstreams.RawAudioMp3Stream;
    ...
    public static final MP3Audio MP3  = new MP3Audio("MP3") {
                                          {
                                              ...
                                              containers = new AbstractMediaContainer[] { RawAudioMp3Stream.INSTANCE, AudioMp4Container.INSTANCE, RawAudioAMRStream.INSTANCE };
