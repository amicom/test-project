...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 3, names = { "rapidsonic.com", "fileparadox.com", "fileparadox.in" }, urls = { "https?://(www\\.)?(fileparadox\\.(in|com)|rapidsonic\\.com)/((vid)?embed-)?[a-z0-9]{12}", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32423", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32423" }, flags = { 2, 0, 0 })
