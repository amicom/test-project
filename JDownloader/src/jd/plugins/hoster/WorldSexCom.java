...
@HostPlugin(revision = "$Revision: 31252 $", interfaceVersion = 2, names = { "worldsex.com" }, urls = { "http://(www\\.)?(worldsex\\.com/videos/[a-z0-9\\-]+\\d+\\.html|movies\\.worldsex\\.com/playerConfig\\.php\\?[a-z0-9]+\\.flv)" }, flags = { 0 })
public class WorldSexCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (downloadLink.getDownloadURL().matches(EMBEDLINK)) {
            ...
            if (br.getURL().contains("worldsex.com/404.php")) {
