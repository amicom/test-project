...
@HostPlugin(revision = "$Revision: 29452 $", interfaceVersion = 2, names = { "freemovies.tv" }, urls = { "http://(www\\.)?freemovies\\.tv/video/[a-z0-9\\-]+/" }, flags = { 0 })
public class FreeMoviesTv extends PluginForHost {

    public FreeMoviesTv(PluginWrapper wrapper) {
        super(wrapper);
    }
