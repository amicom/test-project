...
@HostPlugin(revision = "$Revision: 30661 $", interfaceVersion = 3, names = { "zdf.de", "phoenix.de" }, urls = { "decrypted://(www\\.)?zdf\\.de/ZDFmediathek/[^<>\"]*?beitrag/video/\\d+\\&quality=\\w+", "decrypted://(www\\.)?phoenix\\.de/content/\\d+\\&quality=\\w+" }, flags = { 2, 2 })
