...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "hoodload.com", "gupload.biz" }, urls = { "http://(www\\.)?(gupload\\.biz|hoodload\\.com)/[a-z0-9]+", "jnbg90p345uzj0ß4trjnhetpohnmDELETE_MErz67tzr5nd" }, flags = { 2, 0 })
