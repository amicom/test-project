...
@HostPlugin(revision = "$Revision: 31155 $", interfaceVersion = 2, names = { "ozofiles.com" }, urls = { "https?://(www\\.)?ozofiles\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class OzoFilesCom extends PluginForHost {
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        final String ttt = new Regex(correctedBR, "id=\"countdown_str\">.*?class=\"count\">(\\d+)</span>").getMatch(0);
        if (ttt != null) {
