...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "jippyshare.com" }, urls = { "https?://(www\\.)?jippyshare\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class JippyShareCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://jippyshare.com";
    ...
    public JippyShareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "<b>Filename:</b></td><td nowrap>([^<>\"]*?)</td></tr>").getMatch(0);
        }
        if (fileInfo[1] == null) {
