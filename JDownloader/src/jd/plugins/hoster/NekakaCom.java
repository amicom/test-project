...
@HostPlugin(revision = "$Revision: 25043 $", interfaceVersion = 2, names = { "nekaka.com" }, urls = { "https?://(www\\.)?nekaka\\.com/d/[a-zA-Z0-9\\-\\_]{10}" }, flags = { 2 })
public class NekakaCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (br.containsHTML("(?i)invalid file link|We are sorry, but this file does not exist")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
