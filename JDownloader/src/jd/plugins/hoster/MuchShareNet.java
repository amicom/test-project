...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 3, names = { "muchshare.net" }, urls = { "https?://(www\\.)?muchshare\\.net/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class MuchShareNet extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://muchshare.net";
    // domain names used within download links.
    private final String               DOMAINS                      = "(muchshare\\.net|royalvids\\.eu)";
    ...
    public void correctDownloadLink(final DownloadLink downloadLink) {
        ...
        // set customs
        downloadLink.setUrlDownload(downloadLink.getDownloadURL().replaceAll("royalvids\\.eu/tt/", "royalvids.eu/"));
