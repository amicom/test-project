...
@HostPlugin(revision = "$Revision: 30879 $", interfaceVersion = 2, names = { "video.google.com" }, urls = { "http://(www\\.)?video\\.google\\.(com|de)/(videoplay\\?docid=|googleplayer\\.swf\\?autoplay=1\\&fs=true\\&fs=true\\&docId=)(\\-)?\\d+|https?://redirector\\.googlevideo\\.com/videoplayback\\?.+" }, flags = { 0 })
