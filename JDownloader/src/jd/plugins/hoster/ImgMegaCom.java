...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "imgmega.com" }, urls = { "https?://(www\\.)?imgmega\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImgMegaCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://imgmega.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(imgmega\\.com)";
    ...
    public ImgMegaCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getDllink() {
        ...
        if (dllink == null) {
            ...
            dllink = new Regex(correctedBR, "file:\"(http[^<>\"]*?\\.(?:mp4|flv))\"").getMatch(0);
        }
        if (dllink == null) {
            /* Sometimes used for streaming */
            dllink = new Regex(correctedBR, "\"(http://[^/]+/i/[^<>\"]*?)\"").getMatch(0);
        }
        return dllink;
    }
