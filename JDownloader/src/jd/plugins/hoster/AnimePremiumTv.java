...
@HostPlugin(revision = "$Revision: 27693 $", interfaceVersion = 2, names = { "animepremium.tv" }, urls = { "http://(s\\d000\\.animepremium\\.tv/download/\\d+|embeds\\.animepremium\\.tv/share\\.php\\?id=\\d+)" }, flags = { 0 })
