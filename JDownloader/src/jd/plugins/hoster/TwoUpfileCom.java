...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "2upfile.com" }, urls = { "http://(www\\.)?2upfile\\.com/(?!faq|register|login|terms|report_file|plugins)[a-z0-9]+" }, flags = { 0 })
