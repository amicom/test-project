...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "city-upload.com" }, urls = { "https?://(www\\.)?city\\-upload\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class CityUploadCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://city-upload.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(city\\-upload\\.com)";
    ...
    public CityUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        if (ttt == null) {
            ttt = new Regex(correctedBR, "class=\"counter_bk\">Wait<br /><span id=\"[a-z0-9]+\" class=\"count\">(\\d+)</span>").getMatch(0);
        }
        if (ttt != null) {
