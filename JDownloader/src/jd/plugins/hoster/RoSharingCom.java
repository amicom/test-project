...
@HostPlugin(revision = "$Revision: 31212 $", interfaceVersion = 2, names = { "rosharing.net", "rosharing.com" }, urls = { "https?://(?:www\\.)?(rosharing\\.com|rosharing\\.net|roshare\\.info)/[A-Za-z0-9]+", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32424" }, flags = { 0, 0 })
