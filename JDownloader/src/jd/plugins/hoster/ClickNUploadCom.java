...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "clicknupload.com" }, urls = { "https?://(www\\.)?clicknupload\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ClickNUploadCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://clicknupload.com";
