...
@HostPlugin(revision = "$Revision: 21740 $", interfaceVersion = 2, names = { "pervclips.com" }, urls = { "http://(www\\.)?pervclips\\.com/tube/videos/[^<>\"/]+/" }, flags = { 0 })
public class PervClipsCom extends PluginForHost {

    public PervClipsCom(PluginWrapper wrapper) {
        super(wrapper);
    }
