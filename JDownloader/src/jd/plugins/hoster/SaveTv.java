...
@HostPlugin(revision = "$Revision: 31420 $", interfaceVersion = 3, names = { "save.tv" }, urls = { "https?://(www\\.)?save\\.tv/STV/M/obj/archive/VideoArchiveDetails\\.cfm\\?TelecastID=\\d+" }, flags = { 2 })
public class SaveTv extends PluginForHost {
    ...
    public void showAccountDetailsDialog(final Account account) {
        ...
        if (ai != null) {
            ...
            String revision = "$Revision: 31420 $";
            try {
