...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "cloudsuzy.com" }, urls = { "https?://(www\\.)?cloudsuzy\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class CloudsuzyCom extends PluginForHost {

    public CloudsuzyCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://cloudsuzy.com";
    private final String         domains                                      = "(cloudsuzy\\.com)";
