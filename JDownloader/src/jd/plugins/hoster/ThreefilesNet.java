...
@HostPlugin(revision = "$Revision: 31341 $", interfaceVersion = 2, names = { "3files.net" }, urls = { "https?://(?:www\\.)?3files\\.net/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ThreefilesNet extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://3files.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(3files\\.net)";
    /* Linktypes */
    ...
    @SuppressWarnings("deprecation")
    public ThreefilesNet(PluginWrapper wrapper) {
        super(wrapper);
