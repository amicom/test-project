...
@HostPlugin(revision = "$Revision: 31225 $", interfaceVersion = 2, names = { "up4.im" }, urls = { "https?://(www\\.)?up4\\.im/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class Up4Im extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://up4.im";
    private static final String  NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                      = "(up4\\.im)";
    ...
    // protocol: no https
    // captchatype: null
    // other: TODO: Add account support. Last time tried, their login function was broken serverside: 04.05.2015
    ...
    public Up4Im(PluginWrapper wrapper) {
        super(wrapper);
