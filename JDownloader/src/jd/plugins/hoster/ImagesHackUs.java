...
@HostPlugin(revision = "$Revision: 25438 $", interfaceVersion = 2, names = { "imageshack.com", "imageshack.us" }, urls = { "https?://(www\\.)?imageshack\\.(us|com)/(i/[A-Za-z0-9]+|f/\\d+/[^<>\"/]+)", "z690hi09erhj6r0nrheswhrzogjrtehoDELETE_MEfhjtzjzjzthj" }, flags = { 0, 0 })
