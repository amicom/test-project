...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "filebulk.com" }, urls = { "https?://(www\\.)?filebulk\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FileBulkCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|>REASONS FOR THIS MAY INCLUDE)").matches()) {
