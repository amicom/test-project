...
@HostPlugin(revision = "$Revision: 31391 $", interfaceVersion = 2, names = { "subyshare.com" }, urls = { "https?://(www\\.)?subyshare\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
