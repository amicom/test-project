...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "movreel.com" }, urls = { "http://(www\\.)?movreel\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class MovReelCom extends PluginForHost {

    private String              BRBEFORE            = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://movreel.com";
