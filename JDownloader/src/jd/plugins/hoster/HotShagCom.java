...
@HostPlugin(revision = "$Revision: 25167 $", interfaceVersion = 2, names = { "hotshag.com" }, urls = { "http://(www\\.)?hotshag\\.com/video/\\d+/[a-z0-9\\-_]+\\.html" }, flags = { 0 })
public class HotShagCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (!br.containsHTML("class=\"vd8\"")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
