...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 3, names = { "filepurpose.com" }, urls = { "https?://(www\\.)?filepurpose\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class FilePurposeCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://filepurpose.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(filepurpose\\.com)";
     ...
     * */
    public FilePurposeCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
