...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "imageporter.com" }, urls = { "http://(www\\.)?(imageporter\\.com/[a-z0-9]{12}|img\\d+\\.imageporter\\.com/i/\\d+/[a-z0-9]{12})" }, flags = { 0 })
