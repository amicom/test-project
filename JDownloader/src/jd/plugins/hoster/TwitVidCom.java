...
@HostPlugin(revision = "$Revision: 19611 $", interfaceVersion = 2, names = { "telly.com", "twitvid.com" }, urls = { "http://(www\\.)?tellydecrypted\\.com/[A-Z0-9]+", "djg35zu54o9zhjrofnvfheDELETEMEfdhzk67rfwdefvki" }, flags = { 0, 0 })
