...
@HostPlugin(revision = "$Revision: 31212 $", interfaceVersion = 2, names = { "hcbit.com" }, urls = { "https?://(www\\.)?hcbit\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class HcBitCom extends PluginForHost {

    public HcBitCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    // mods:
    // limit-info: unknown, tests impossible
    // protocol: no https
    // captchatype: unknown
    // other:
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://hcbit.com";
    private final String         domains                                      = "(hcbit\\.com)";
