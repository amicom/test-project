...
@HostPlugin(revision = "$Revision: 27851 $", interfaceVersion = 2, names = { "firedrive.com", "putlocker.com" }, urls = { "https?://(www\\.)?(m\\.)?(putlocker|firedrive)\\.com/(file|embed|mobile/file)/[A-Z0-9]+", "dg56i8zg3ufgrheiugrio9gh59zjder9gjKILL_ME_V2_frh6ujtzj" }, flags = { 2, 0 })
