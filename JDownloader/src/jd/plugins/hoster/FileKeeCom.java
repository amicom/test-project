...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "filekee.com" }, urls = { "https?://(www\\.)?filekee\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class FileKeeCom extends PluginForHost {

    public FileKeeCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://filekee.com";
    private final String         domains                                      = "(filekee\\.com)";
