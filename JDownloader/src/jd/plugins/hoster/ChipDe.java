...
@HostPlugin(revision = "$Revision: 31341 $", interfaceVersion = 2, names = { "chip.de" }, urls = { "http://(www\\.)?(chip\\.de/downloads|download\\.chip\\.(eu|asia)/.{2})/[A-Za-z0-9\\-]+_\\d+\\.html|http://(www\\.)?chip\\.de/video/[A-Za-z0-9\\-]+_\\d+\\.html" }, flags = { 0 })
