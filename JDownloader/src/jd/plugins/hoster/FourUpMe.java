...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "4upfiles.com" }, urls = { "https?://(www\\.)?(4upfiles\\.com|4up\\.(im|me))/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FourUpMe extends PluginForHost {
    ...
    public FourUpMe(PluginWrapper wrapper) {
        super(wrapper);
