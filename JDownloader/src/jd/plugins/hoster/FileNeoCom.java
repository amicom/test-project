...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "fileneo.com" }, urls = { "https?://(www\\.)?fileneo\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileNeoCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://fileneo.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(fileneo\\.com)";
    ...
    // mods: Added support for (near) direct links, fixFilename[Removed host tags]
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public FileNeoCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        dllink = new Regex(correctedBR, "window\\.location = \"(https?://fileneo\\.com/files[^<>\"]*?)\"").getMatch(0);
        if (dllink != null) {
        ...
        if (fileInfo[0] == null) {
            ...
            if (fileInfo[0] == null) {
                ...
                if (fileInfo[0] == null) {
                    ...
                    if (fileInfo[0] == null) {
                        fileInfo[0] = new Regex(correctedBR, "Filename:[^<]*?(<[^>]+>\\s*)+?([^<>\"']+)</td>").getMatch(1);
    ...
    private void fixFilename(final DownloadLink downloadLink) {
        ...
        FFN = FFN.replace("-Hotlinked-by-Fileneo-com", "");
