...
@HostPlugin(revision = "$Revision: 30387 $", interfaceVersion = 3, names = { "e-hentai.org", "exhentai.org" }, urls = { "http://g\\.e\\-hentai\\.orgdecrypted\\d+", "http://exhentai\\.orgdecrypted\\d+" }, flags = { 2, 2 })
