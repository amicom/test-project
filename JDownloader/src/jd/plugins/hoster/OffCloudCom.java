...
@HostPlugin(revision = "$Revision: 31352 $", interfaceVersion = 3, names = { "offcloud.com" }, urls = { "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsfs2133" }, flags = { 2 })
public class OffCloudCom extends PluginForHost {
    ...
    private void updatestatuscode() {
        ...
        if (error != null) {
            if (error.equals("Please enter a valid email address.")) {
                ...
                statuscode = 10;
            } else if (error.matches("Premium account quota for .*? exceeded today\\. Please try to download again later\\.")) {
                statuscode = 11;
    ...
    public void showAccountDetailsDialog(final Account account) {
        ...
        if (ai != null) {
            ...
            String revision = "$Revision: 31352 $";
