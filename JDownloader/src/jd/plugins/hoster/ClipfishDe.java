...
@HostPlugin(revision = "$Revision: 31417 $", interfaceVersion = 3, names = { "clipfish.de" }, urls = { "http://(?:www\\.)?clipfish\\.de/(?:.*?channel/\\d+/video/\\d+|video/\\d+(?:/.+)?|special/.*?/video/\\d+|musikvideos/video/\\d+(?:/.+)?)" }, flags = { 0 })
