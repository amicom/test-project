...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "sharelink.li" }, urls = { "https?://(www\\.)?sharelink\\.li/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class ShareLinkLi extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String            COOKIE_HOST                  = "http://sharelink.li";
    // domain names used within download links.
    private static final String            DOMAINS                      = "(sharelink\\.li)";
    ...
    // mods:
    // limit-info: free limits unknown, took standard limits
    // protocol: no https
    ...
    // @Override
    public boolean not_checkLinks(final DownloadLink[] urls) {
