...
@HostPlugin(revision = "$Revision: 31155 $", interfaceVersion = 2, names = { "jumbofiles.org" }, urls = { "http://(www\\.)?(jumbofiles\\.org|jumbofilebox\\.com|putcker\\.com|mediafile\\.co|10shared\\.com)/(linkfile|newfile)\\?n=\\d+" }, flags = { 2 })
