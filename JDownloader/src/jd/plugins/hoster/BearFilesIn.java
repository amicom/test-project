...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "bearfiles.in" }, urls = { "https?://(www\\.)?bearfiles\\.in/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BearFilesIn extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://bearfiles.in";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(bearfiles\\.in)";
    ...
    public BearFilesIn(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "You have requested.*?https?://(www\\.)?" + DOMAINS + "/" + fuid + "/(.*?)\" readonly=\"true\"").getMatch(2);
            if (fileInfo[0] == null) {
