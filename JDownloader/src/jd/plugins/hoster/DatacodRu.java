...
@HostPlugin(revision = "$Revision: 25095 $", interfaceVersion = 2, names = { "data.cod.ru" }, urls = { "http://[a-zA-Z.]{0,}data.cod.ru/[0-9]{1,}" }, flags = { 0 })
public class DatacodRu extends PluginForHost {
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception {
        ...
        if (dlLink == null) /*
                             * добавил обработку ссылок вида http://data.cod.ru/164947
                             */
        dlLink = br.getRegex(Pattern.compile("<a href=\"(http://out.*?)\" class=\"button\">Скачать файл</a>")).getMatch(0);
