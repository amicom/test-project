...
@HostPlugin(revision = "$Revision: 31038 $", interfaceVersion = 2, names = { "daf.fm" }, urls = { "http://(www\\.)?daf\\.fm/video/[^<>\"/]+\\.html|http://www\\d+\\.anleger\\-fernsehen\\.de/[a-z0-9\\-_]+\\.html\\?id=\\d+" }, flags = { 0 })
