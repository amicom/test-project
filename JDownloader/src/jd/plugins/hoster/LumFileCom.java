...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 3, names = { "lumfile.com" }, urls = { "z77iojtjftjrDELETE_MEfh65iiubf_MOVED_TO_TeraFileCo_PLUGINrei5754dfrghrghrhijnfdwihjdwiojn" }, flags = { 2 })
...
public class LumFileCom extends PluginForHost {
    ...
    // captchatype:
    // other: no redirects, keywords: terafile.co
    // mods: life time hacks!
    ...
    private void setConstants(final Account account) {
        ...
        } else if (account != null && !account.getBooleanProperty("free") && account.getBooleanProperty("lifetime")) {
            // lifetime account
            chunks = -10;
            resumes = true;
            acctype = "Lifetime Premium Account";
     ...
     * */
    public LumFileCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
    ...
    private void checkErrors(final DownloadLink theLink, final Account account, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        final String pr = "(Please Buy Premium To download this file<|>This file is available for Premium Users only\\.<|Unfortunately, the file owner has limited free downloads of this file|premium membership is required to download this file\\.<)";
        // let the fun begin!
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        if (account.getBooleanProperty("free")) {
            ...
            if (cbr.containsHTML("Premium account expire:</TD>([\r\n\t ]+)?<TD><b>Lifetime</b>")) {
                ...
                if (!inValidate(expireDay)) {
                    expireD = TimeFormatter.getMilliSeconds(expireDay, "yyyy-MM-dd", Locale.ENGLISH);
                }
