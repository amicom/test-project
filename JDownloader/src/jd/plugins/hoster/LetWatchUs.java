...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "letwatch.us" }, urls = { "https?://(www\\.)?letwatch\\.us(\\.com)?/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class LetWatchUs extends PluginForHost {
    ...
    private static final String            DOMAINS                      = "(letwatch\\.us|letwatch\\.us\\.com)";
