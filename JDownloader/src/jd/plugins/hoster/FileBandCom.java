...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "fileband.com" }, urls = { "http://(www\\.)?fileband\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileBandCom extends PluginForHost {

    private String              BRBEFORE     = "";

    private static final String PASSWORDTEXT = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST  = "http://fileband.com";

    public boolean              NOPREMIUM    = false;

    public FileBandCom(PluginWrapper wrapper) {
        super(wrapper);
