...
@HostPlugin(revision = "$Revision: 31032 $", interfaceVersion = 3, names = { "megacrypter" }, urls = { "https?://(?:www\\.)?(encrypterme\\.ga|megacrypter\\.noestasinvitado\\.com|youpaste\\.co|(?:megacrypter\\.)?linkcrypter\\.net)/(!|%21)[A-Za-z0-9\\-_\\!%]+" }, flags = { 2 })
