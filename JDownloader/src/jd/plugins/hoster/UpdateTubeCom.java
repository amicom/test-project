...
@HostPlugin(revision = "$Revision: 28749 $", interfaceVersion = 2, names = { "updatetube.com", "thenewporn.com", "pinkrod.com", "hotshame.com" }, urls = { "http://(www\\.)?updatetube\\.com/videos/\\d+/[a-z0-9\\-]+/", "http://(www\\.)?thenewporn\\.com/videos/\\d+/[a-z0-9\\-]+/", "http://(www\\.)?pinkrod\\.com/videos/\\d+/[a-z0-9\\-]+/", "http://(www\\.)?hotshame\\.com/videos/\\d+/[a-z0-9\\-]+/" }, flags = { 0, 0, 0, 0 })
public class UpdateTubeCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.updatetube.com/work_terms.php";
    }
