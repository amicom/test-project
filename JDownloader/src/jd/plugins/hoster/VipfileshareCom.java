...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "vipfileshare.com" }, urls = { "https?://(www\\.)?vipfileshare\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class VipfileshareCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://vipfileshare.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(vipfileshare\\.com)";
    ...
    public VipfileshareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        /* Don't use the 2 RegExes below as they pick up wrong info. Status 11.05.2015: Filesize not given on main page */
        // // generic failover#1
        // if (fileInfo[1] == null) {
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        if (ttt == null) {
            ttt = new Regex(correctedBR, "id=\"[a-z0-9]+\">(\\d+)</span> seconds").getMatch(0);
        }
        if (ttt != null) {
