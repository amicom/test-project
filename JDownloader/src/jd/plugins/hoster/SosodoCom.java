...
@HostPlugin(revision = "$Revision: 29830 $", interfaceVersion = 2, names = { "mvpdj.com", "sosodo.com" }, urls = { "http://(www\\.)?mvpdj\\.com/song/player/\\d+", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32423" }, flags = { 0, 0 })
