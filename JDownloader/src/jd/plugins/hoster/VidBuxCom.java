...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 3, names = { "vidbux.com" }, urls = { "https?://(www\\.)?vidbux\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class VidBuxCom extends PluginForHost {
     ...
     * */
    public VidBuxCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
    ...
    private void doFree(final DownloadLink downloadLink, final Account account) throws Exception, PluginException {
        ...
        if (inValidate(dllink)) {
            ...
            if (download1 != null) {
                ...
                if (captchaLastUsed != null && getFormByKey(cbr, "op", "download1") != null && containsLastUsedCaptcha(getFormByKey(cbr, "op", "download1").getHtmlCode())) {
    ...
    private boolean containsLastUsedCaptcha(String s) {
        if (captchaLastUsed == null || s == null) {
            return false;
        }
