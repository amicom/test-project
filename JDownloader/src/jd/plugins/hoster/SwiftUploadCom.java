...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "swiftupload.com" }, urls = { "https?://(www\\.)?swiftupload\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class SwiftUploadCom extends PluginForHost {

    public SwiftUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://swiftupload.com";
    private final String         domains                                      = "(swiftupload\\.com)";
