...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "filecore.co.nz" }, urls = { "https?://(www\\.)?(filecore\\.co\\.nz|filecore\\.co|fcore\\.eu)/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FilecoreCoNz extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://filecore.co.nz";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(filecore\\.co\\.nz|filecore\\.co)";
    ...
    // mods:requestFileInformation (because no filename is provided)
    // limit-info:
    // protocol: no https
    // captchatype: 4dignum
    // other:
    ...
    public FilecoreCoNz(PluginWrapper wrapper) {
        super(wrapper);
