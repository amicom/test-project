...
@HostPlugin(revision = "$Revision: 29375 $", interfaceVersion = 2, names = { "pornstarnetwork.com" }, urls = { "http://(www\\.)?pornstarnetwork\\.com/video/(([a-z0-9\\-_]+)?\\d+\\.html|embed\\?id=\\d+)" }, flags = { 0 })
