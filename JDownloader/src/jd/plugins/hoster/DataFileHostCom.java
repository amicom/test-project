...
@HostPlugin(revision = "$Revision: 30180 $", interfaceVersion = 2, names = { "datafilehost.com" }, urls = { "http://((www\\.)?datafilehost\\.com/(download\\-[a-z0-9]+\\.html|d/[a-z0-9]+)|www\\d+\\.datafilehost\\.com/d/[a-z0-9]+)" }, flags = { 0 })
