...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "jumbofile.net" }, urls = { "https?://(www\\.)?jumbofile\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class JumbofileNet extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://jumbofile.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(jumbofile\\.net)";
    ...
    public JumbofileNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|File Not Found|>(The|This) file (was)? (removed|expired|deleted)|Reason for deletion:\n)").matches()) {
