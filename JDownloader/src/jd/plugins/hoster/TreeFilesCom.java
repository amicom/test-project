...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 3, names = { "treefiles.com" }, urls = { "https?://(www\\.)?((treefiles|treesfile)\\.com|treefile\\.org)/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
