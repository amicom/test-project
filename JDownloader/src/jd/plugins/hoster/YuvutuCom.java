...
@HostPlugin(revision = "$Revision: 29569 $", interfaceVersion = 2, names = { "yuvutu.com" }, urls = { "http://(www\\.)?yuvutu.com/(video/\\d+/|modules\\.php\\?name=Video\\&op=view\\&video_id=\\d+)" }, flags = { 2 })
