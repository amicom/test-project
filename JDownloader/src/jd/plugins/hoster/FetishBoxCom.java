...
@HostPlugin(revision = "$Revision: 30934 $", interfaceVersion = 3, names = { "fetishbox.com", "bondagebox.com" }, urls = { "http://(www\\.)?fetishbox\\.com/videos/[a-z0-9\\-]+\\.html", "http://(www\\.)?bondagebox\\.com/videos/[a-z0-9\\-]+\\.html" }, flags = { 0, 0 })
