...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "terafile.co", "lumfile.com" }, urls = { "https?://(www\\.)?(terafile\\.co|lumfile\\.(com|se|eu))/((vid)?embed\\-)?[a-z0-9]{12}", "z77iojtjftjrDELETE_MEfh65iiubfrei5754dfrghrghrhijnfdwihjdwiojn" }, flags = { 2, 0 })
