...
@HostPlugin(revision = "$Revision: 31407 $", interfaceVersion = 2, names = { "myspass.de", "tvtotal.prosieben.de" }, urls = { "http://(?:www\\.)?myspass\\.de/(?:myspass/)?shows/(?:tv|web)shows/[a-z0-9\\-_]+/[A-Za-z0-9\\-_]+/\\d+", "http://tvtotal\\.prosieben\\.de/videos/.*?/\\d+/" }, flags = { 0, 0 })
