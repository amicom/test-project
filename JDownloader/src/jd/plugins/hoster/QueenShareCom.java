...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "queenshare.com" }, urls = { "https?://(www\\.)?queenshare\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class QueenShareCom extends PluginForHost {
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://queenshare.com";
    private final String         domains                                      = "(queenshare\\.com)";
