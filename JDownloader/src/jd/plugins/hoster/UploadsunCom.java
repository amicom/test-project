...
@HostPlugin(revision = "$Revision: 31341 $", interfaceVersion = 2, names = { "uploadsun.com" }, urls = { "https?://(www\\.)?uploadsun\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class UploadsunCom extends PluginForHost {

    public UploadsunCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://uploadsun.com";
    private final String         domains                                      = "(uploadsun\\.com)";
