...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "imgspice.com" }, urls = { "https?://(www\\.)?imgspice\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ImgSpiceCom extends PluginForHost {
    ...
    public String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) dllink = new Regex(correctedBR, "\"(http://[a-z0-9]+\\." + DOMAINS + "/i/[^<>\"]*?)\"").getMatch(0);
            if (dllink == null) {
