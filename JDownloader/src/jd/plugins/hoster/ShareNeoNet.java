...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "shareneo.net" }, urls = { "http://(www\\.)?shareneo\\.net/(?!faq|register|login|terms|report_file)[a-z0-9]+" }, flags = { 0 })
