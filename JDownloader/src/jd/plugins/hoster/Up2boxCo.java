...
@HostPlugin(revision = "$Revision: 31155 $", interfaceVersion = 2, names = { "up2box.co" }, urls = { "https?://(www\\.)?up2box\\.co/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class Up2boxCo extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://up2box.co";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(up2box\\.co|uptobox\\.net)";
    /* Linktypes */
    ...
    @SuppressWarnings("deprecation")
    public Up2boxCo(PluginWrapper wrapper) {
        super(wrapper);
