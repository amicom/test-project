...
@HostPlugin(revision = "$Revision: 31165 $", interfaceVersion = 2, names = { "anyfiles.org" }, urls = { "https?://(www\\.)?anyfiles\\.org/[A-Za-z0-9]+" }, flags = { 2 })
public class AnyfilesOrg extends PluginForHost {

    public AnyfilesOrg(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://anyfiles.org";
    private final String         domains                                      = "(anyfiles\\.org)";
