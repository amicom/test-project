...
@DecrypterPlugin(revision = "$Revision: 30247 $", interfaceVersion = 2, names = { "archive.org" }, urls = { "https?://(www\\.)?archive\\.org/(?:details|download)/(?!copyrightrecords)[A-Za-z0-9_\\-\\.]+$" }, flags = { 0 })
