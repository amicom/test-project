...
@DecrypterPlugin(revision = "$Revision: 31185 $", interfaceVersion = 2, names = { "amazon.com" }, urls = { "https?://(www\\.)?amazon\\.(de|es|com|com\\.au|co\\.uk|fr)/clouddrive/share/.+|https?://(?:www\\.)?amazon\\.com/clouddrive/share.+" }, flags = { 0 })
