...
@DecrypterPlugin(revision = "$Revision: 27593 $", interfaceVersion = 2, names = { "moevideos.net" }, urls = { "http://(www\\.)?(moevideos|videochart)\\.net/((\\?page=video\\&uid=|video/|video\\.php\\?file=|swf/letplayerflx3\\.swf\\?file=)[0-9a-f\\.]+|online/\\d+)" }, flags = { 0 })
