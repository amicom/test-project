...
@DecrypterPlugin(revision = "$Revision: 27815 $", interfaceVersion = 2, names = { "moviz-protect.com" }, urls = { "https?://(www\\.)?moviz\\-protect\\.com/protected\\.php\\?hash=[a-f0-9]{32}" }, flags = { 0 })
