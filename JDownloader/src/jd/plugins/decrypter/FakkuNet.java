...
@DecrypterPlugin(revision = "$Revision: 30502 $", interfaceVersion = 3, names = { "fakku.net" }, urls = { "https?://(www\\.)?fakku\\.net/((viewmanga|viewonline)\\.php\\?id=\\d+|[a-z0-9\\-_]+/[a-z0-9\\-_]+/read)" }, flags = { 0 })
