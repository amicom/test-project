...
@DecrypterPlugin(revision = "$Revision: 30675 $", interfaceVersion = 2, names = { "gameone.de" }, urls = { "https?://((www|m)\\.)?gameone\\.de/(tv/\\d+(\\?part=\\d+)?|blog/\\d+/\\d+/.+|playtube/[\\d\\w\\-]+/\\d+(/(sd|hd))?)" }, flags = { 0 })
