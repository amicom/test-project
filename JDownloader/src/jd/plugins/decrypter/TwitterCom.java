...
@DecrypterPlugin(revision = "$Revision: 31409 $", interfaceVersion = 2, names = { "twitter.com", "t.co" }, urls = { "https?://(www\\.)?twitter\\.com/[A-Za-z0-9_\\-]+/(media|status/\\d+.*?)|https://twitter\\.com/i/cards/tfw/v1/\\d+", "https?://t\\.co/[a-zA-Z0-9]+" }, flags = { 0, 0 })
