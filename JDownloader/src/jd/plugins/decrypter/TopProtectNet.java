...
@DecrypterPlugin(revision = "$Revision: 30889 $", interfaceVersion = 2, names = { "top-protection.net" }, urls = { "http://(www\\.)?top\\-protect(ion)?\\.net/linkidwoc\\.php\\?linkid=[a-z]+" }, flags = { 0 })
