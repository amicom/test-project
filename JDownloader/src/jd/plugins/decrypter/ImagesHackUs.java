...
@DecrypterPlugin(revision = "$Revision: 26355 $", interfaceVersion = 2, names = { "imageshack.us" }, urls = { "https?://(www\\.)?(img[0-9]{1,4}\\.imageshack\\.us/(g/|my\\.php\\?image=[a-z0-9]+|i/[a-z0-9]+)\\.[a-zA-Z0-9]{2,4}|imageshack\\.us/photo/[^<>\"\\'/]+/\\d+/[^<>\"\\'/]+|imageshack\\.(com|us)/user/[A-Za-z0-9\\-_]+)" }, flags = { 0 })
