...
@DecrypterPlugin(revision = "$Revision: 31155 $", interfaceVersion = 2, names = { "shahid.mbc.net" }, urls = { "https?://(www\\.)?(shahid\\.mbc\\.net/(media/video|ar/episode)/\\d+(/\\w+)?|bluefishtv\\.com/Store/[_a-zA-Z]+/\\d+/.*)" }, flags = { 0 })
