...
@DecrypterPlugin(revision = "$Revision: 30367 $", interfaceVersion = 3, names = { "keeplinks.me", "safemy.link" }, urls = { "https?://(www\\.)?keeplinks\\.(me|eu)/(p|d)/[a-z0-9]+", "http://(www\\.)?safemy\\.link/(p|d)/[a-z0-9]+" }, flags = { 0, 0 })
