...
@DecrypterPlugin(revision = "$Revision: 31350 $", interfaceVersion = 2, names = { "drss.tv" }, urls = { "http://(www\\.)?drss\\.tv/(sendung/\\d{2}\\-\\d{2}\\-\\d{4}|video/[a-z0-9\\-]+|profil/[a-z0-9\\-]+|[a-z0-9\\-]+)/" }, flags = { 0 })
