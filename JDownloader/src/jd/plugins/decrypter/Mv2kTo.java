...
@DecrypterPlugin(revision = "$Revision: 30159 $", interfaceVersion = 2, names = { "movie2k.to" }, urls = { "https?://(www\\.)?movie(2|4)k\\.to//?(?!movies\\-(all|genre)|tvshows\\-season)(tvshows\\-\\d+\\-[^<>\"/]*?\\.html|[^<>\"/]*\\-\\d+|\\d+\\-[^<>\"/]*?)(\\.html)?" }, flags = { 0 })
