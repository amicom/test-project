...
@DecrypterPlugin(revision = "$Revision: 22520 $", interfaceVersion = 2, names = { "3dl.tv" }, urls = { "http://(www\\.)?(music|games|movies|serien|apps|porn)\\.3dl\\.tv/(download/\\d+/[^<>\"/]+/detail\\.html|folder/[a-z0-9]+)" }, flags = { 0 })
