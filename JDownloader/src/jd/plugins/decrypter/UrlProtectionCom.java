...
@DecrypterPlugin(revision = "$Revision: 27854 $", interfaceVersion = 2, names = { "url-protection.com" }, urls = { "http://(www\\.)?url\\-protection\\.com/(linkidwoc|)\\.php\\?linkid=[a-z0-9]+" }, flags = { 0 })
