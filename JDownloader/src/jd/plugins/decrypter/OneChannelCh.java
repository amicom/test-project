 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 29260 $", interfaceVersion = 2, names = { "1channel.ch" }, urls = { "https?://(www\\.)?(vodly\\.to|primewire\\.ag)/(watch\\-\\d+([A-Za-z0-9\\-_]+)?|tv\\-\\d+[A-Za-z0-9\\-_]+/season\\-\\d+\\-episode\\-\\d+)" }, flags = { 0 })
