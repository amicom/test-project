...
@DecrypterPlugin(revision = "$Revision: 30387 $", interfaceVersion = 3, names = { "e-hentai.org", "exhentai.org" }, urls = { "http://(?:www\\.)?g\\.e-hentai\\.org/g/(\\d+)/[a-z0-9]+", "http://(?:www\\.)?exhentai\\.org/g/(\\d+)/[a-z0-9]+" }, flags = { 0, 0 })
