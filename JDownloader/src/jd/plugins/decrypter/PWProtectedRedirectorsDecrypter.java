...
@DecrypterPlugin(revision = "$Revision: 30897 $", interfaceVersion = 2, names = { "cliccami.info", "mylink4u.info" }, urls = { "http://[\\w\\.]*?cliccami\\.info/[0-9a-z]+", "http://[\\w\\.]*?mylink4u\\.info/[a-z0-9]+" }, flags = { 0, 0 })
