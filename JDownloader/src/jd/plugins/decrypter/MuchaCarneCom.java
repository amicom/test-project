...
@DecrypterPlugin(revision = "$Revision: 30818 $", interfaceVersion = 3, names = { "muchacarne.com" }, urls = { "http://(www\\.)?muchacarne\\.(com|xxx)/hosted(\\-id\\d+\\-.*?\\.html|/media/[a-z0-9\\-]+,\\d+\\.php)" }, flags = { 0 })
